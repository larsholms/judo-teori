...
const QUIZ_DATA = {
  ...
  "1kyu": {
    ...
    questions: [
      ...
      { q: "Hvordan oversættes YOKO-TOMOE-NAGE på pensumsiden for 1. kyu?", options: ["Sideliggende cirkelkast", "Stående cirkelkast", "Omvendt cirkelkast", "Flydende hoftekast"], answer: 0 },
      ...
      { q: "Hvilket ordled i SOTO-MAKIKOMI betyder 'rulle' ifølge ordlisten?", options: ["Maki", "Soto", "Komi", "Nage"], answer: 0 },
      ...
      { q: "Hvilken kasteteknik findes på 1. kyu-siden, men ikke på 2. kyu-siden?", options: ["HIZA-GURUMA", "UCHI-MATA", "SUKUI-NAGE", "KATA-GURUMA"], answer: 0 },
      { q: "Hvilken 1. kyu-kasteteknik er ny i forhold til kastelisten på 2. kyu-siden?", options: ["TOMOE-NAGE", "SEOI-NAGE (ERI)", "TSURIKOMI-GOSHI", "UCHI-MATA"], answer: 0 },
      ...
      { q: "Hvad betyder GURUMA?", options: ["Kontrol", "Hjul", "Kast", "Snoning"], answer: 1 },
      { q: "Hvad betyder TOMOE ifølge ordlisten?", options: ["Bue", "Dal", "Storm", "Bagside"], answer: 0 },
      { q: "Hvad betyder KOMI?", options: ["Udvendig", "Indad", "Trække", "Rulle"], answer: 1 },
